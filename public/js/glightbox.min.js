!(function (e, t) {
  ...
  function _(e, t, i, n) {
    ...
    d(l, "gvideo-container"),
      r.insertBefore(y('<div className="gvideo-wrapper"></div>'), r.firstChild);
  ...
  function B(e, t, i, n) {
    ...
    if (
      a &&
      (k(a) && (s = y('<div className="ginlined-content">'.concat(a, "</div>"))),
      E(a))
    ) {
      ...
      [
        ...
        },
        {
          ...
          value: function (e) {
            ...
            return l
              ? ((n = null),
                o + '... <a href="#" className="desc-more">' + i + "</a>")
              : o;
          },
        },
        {
